...
export type CreateIssueMutation = (
  ...
  & { createIssue?: Maybe<(
    { __typename?: 'CreateIssuePayload' }
    & Pick<CreateIssuePayload, 'clientMutationId'>
  )> }
);
...
export type CreateLabelMutation = (
  ...
  & { createLabel?: Maybe<(
    { __typename?: 'CreateLabelPayload' }
    & Pick<CreateLabelPayload, 'clientMutationId'>
  )> }
);
...
export type CreateRepositoryMutation = (
  ...
  & { createRepository?: Maybe<(
    ...
    & { repository?: Maybe<(
      { __typename?: 'Repository' }
      & Pick<Repository, 'id' | 'isTemplate' | 'url'>
    )> }
  )> }
);
  ...
  & { repository?: Maybe<(
    ...
    & { labels?: Maybe<(
      ...
      & { pageInfo: (
        ...
        & { node?: Maybe<(
          { __typename?: 'Label' }
          & Pick<Label, 'id' | 'color' | 'name' | 'description'>
        )> }
      )>>> }
    )> }
  )> }
...
export type GetRepositoryQuery = (
  ...
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'id' | 'url' | 'isTemplate'>
  )> }
);
...
export type ImportRepositoryMutationVariables = Exact<{
  name: Scalars['String'];
  ownerId: Scalars['ID'];
  repositoryId: Scalars['ID'];
}>;
...
export type ImportRepositoryMutation = (
  { __typename?: 'Mutation' }
...
export const CreateIssueDocument = gql`
    mutation createIssue($body: String, $labelIds: [ID!], $repositoryId: ID!, $title: String!) {
  createIssue(input: {body: $body, labelIds: $labelIds, repositoryId: $repositoryId, title: $title}) {
    clientMutationId
  }
}
    `;
...
export const CreateRepositoryDocument = gql`
  ...
  createRepository(input: {ownerId: $ownerId, name: $name, visibility: PUBLIC}) {
    repository {
      id
      isTemplate
      url
...
export const DeleteLabelDocument = gql`
  ...
  export class DeleteLabelGQL extends Apollo.Mutation<DeleteLabelMutation, DeleteLabelMutationVariables> {
    document = DeleteLabelDocument;
...
export const GetRepositoryDocument = gql`
  ...
  export class GetRepositoryGQL extends Apollo.Query<GetRepositoryQuery, GetRepositoryQueryVariables> {
...
export const ImportRepositoryDocument = gql`
    mutation importRepository($name: String!, $ownerId: ID!, $repositoryId: ID!) {
  cloneTemplateRepository(input: {name: $name, ownerId: $ownerId, repositoryId: $repositoryId, visibility: PUBLIC}) {
    repository {
      id
      url
      isTemplate
  ...
  export class ImportRepositoryGQL extends Apollo.Mutation<ImportRepositoryMutation, ImportRepositoryMutationVariables> {
    document = ImportRepositoryDocument;
